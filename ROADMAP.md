...
Only work in the current era is active. Moving to the next era requires evidence that the current era's exit criteria are met.
...
**Exit:** a small evaluated corpus supports reliable research outputs with citations.
...
**Status:** Active. Both concise and detailed Thai options failed their comprehension gates; preference fit has not produced a measured learning benefit. No listener-profile implementation or implicit preference inference is approved.
...
**Exit:** ecosystem growth preserves constitutional and quality standards.
